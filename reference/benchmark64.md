...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.011  0.011     0.011              0          0        0
#> factor   1.000  1.000     1.000            Inf        Inf      Inf
#> 
#> === sortordercache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.011  0.011     0.011          0.004          0        0
#> factor   1.000  1.000     1.000          2.750        Inf      Inf
#> 
#> === ordercache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.011  0.011     0.011          0.004      0.007        0
#> factor   1.000  1.000     1.000          2.750      1.571      Inf
#> 
#> === allcache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.011  0.011     0.011          0.004      0.007    0.005
#> factor   1.000  1.000     1.000          2.750      1.571    2.200
#> 
...
#> SESSION        0.011  0.011     0.011          0.004      0.007
#>               allcache
#> cache            0.000
#> match(s, b)      0.000
#> s %in% b         0.000
...
#> duplicated(b)      1    Inf       Inf            Inf        Inf
#> unique(b)        NaN    NaN       NaN            NaN        NaN
#> table(b)           1      2         2            Inf        Inf
#> sort(b)          NaN    NaN       NaN            NaN        NaN
#> order(b)         NaN    NaN         0            NaN        NaN
#> rank(b)            1    Inf       Inf            Inf        Inf
#> quantile(b)      NaN    NaN         0            NaN        NaN
#> summary(b)         1    Inf         1            Inf        Inf
#> factor(b)          1      1         2            Inf        Inf
#> SESSION            1      1         1           2.75      1.571
#>               allcache
#> cache              NaN
#> match(s, b)        Inf
...
#> order(b)       0.000  0.000     0.001          0.000      0.000
#> rank(b)        0.001  0.000     0.000          0.000      0.000
#> quantile(b)    0.000  0.000     0.004          0.001      0.000
...
#> table(b)           1      2         2            Inf        Inf
#> sort(b)          NaN    NaN       NaN           0.00        NaN
#> order(b)         NaN    NaN         0            NaN        NaN
#> rank(b)            1    Inf       Inf            Inf        Inf
#> quantile(b)      NaN    NaN         0           0.00        NaN
#> summary(b)         1    Inf         1           1.00        Inf
#> factor(b)          1      1         2           2.00        Inf
#> SESSION            1      1         1           2.75      1.571
#>               allcache
#> cache              NaN
#> match(s, b)        Inf
...
#> rank(b)            1    Inf       Inf            Inf        Inf
#> quantile(b)      NaN    NaN         0           0.00        NaN
#> summary(b)         1    Inf         1           1.00      1.000
#> factor(b)          1      1         2           2.00      2.000
#> SESSION            1      1         1           2.75      1.571
#>               allcache
#> cache              NaN
#> match(s, b)        Inf
