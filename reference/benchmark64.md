...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds   0.01  0.014      0.01              0          0        0
#> factor    1.00  0.714      1.00            Inf        Inf      Inf
#> 
#> === sortordercache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds   0.01  0.014      0.01          0.008          0        0
#> factor    1.00  0.714      1.00          1.250        Inf      Inf
#> 
#> === ordercache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds   0.01  0.014      0.01          0.008      0.006        0
#> factor    1.00  0.714      1.00          1.250      1.667      Inf
#> 
#> === allcache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds   0.01  0.014      0.01          0.008      0.006     0.02
#> factor    1.00  0.714      1.00          1.250      1.667     0.50
#> 
...
#> quantile(b)    0.001  0.000      0.00          0.000      0.000
#> summary(b)     0.001  0.000      0.00          0.000      0.000
#> factor(b)      0.002  0.000      0.00          0.000      0.000
#> SESSION        0.010  0.014      0.01          0.008      0.006
#>               allcache
#> cache             0.00
#> match(s, b)       0.00
#> s %in% b          0.00
...
#> b %in% b       0.001  0.001      0.00          0.000      0.000
...
#> quantile(b)    0.001  0.000      0.00          0.000      0.000
#> summary(b)     0.001  0.001      0.00          0.000      0.000
#> factor(b)      0.002  0.002      0.00          0.000      0.000
#> SESSION        0.010  0.014      0.01          0.008      0.006
#>               allcache
#> cache             0.00
#> match(s, b)       0.00
...
#> SESSION           0.02
#> factor              32-bit 64-bit hashcache sortordercache ordercache
#> cache            NaN    NaN      0.00           0.00        NaN
#> match(s, b)      NaN    NaN      0.00           0.00        NaN
#> s %in% b         NaN    NaN      0.00           0.00        NaN
#> match(b, s)      NaN    NaN      0.00           0.00        NaN
#> b %in% s         NaN  0.000      0.00           0.00        NaN
#> match(b, b)      NaN  0.000      0.00           0.00        NaN
#> b %in% b           1  1.000      1.00           1.00        Inf
#> duplicated(b)    NaN  0.000       NaN            NaN        NaN
#> unique(b)        NaN    NaN       NaN            NaN        NaN
#> table(b)           1    Inf      2.00            Inf        Inf
#> sort(b)            1    Inf      1.00            Inf        Inf
#> order(b)         NaN  0.000      0.00           0.00        NaN
#> rank(b)            1  1.000      0.25            Inf        Inf
#> quantile(b)        1    Inf      1.00           1.00        Inf
#> summary(b)         1  1.000      1.00           1.00        Inf
...
#> SESSION           0.02
#> factor              32-bit 64-bit hashcache sortordercache ordercache
#> cache            NaN    NaN      0.00           0.00      0.000
#> match(s, b)      NaN    NaN      0.00           0.00      0.000
#> s %in% b         NaN    NaN      0.00           0.00      0.000
#> match(b, s)      NaN    NaN      0.00           0.00      0.000
#> b %in% s         NaN  0.000      0.00           0.00      0.000
#> match(b, b)      NaN  0.000      0.00           0.00      0.000
#> b %in% b           1  1.000      1.00           1.00      1.000
#> duplicated(b)    NaN  0.000       NaN            NaN        NaN
#> unique(b)        NaN    NaN       NaN            NaN        NaN
#> table(b)           1    Inf      2.00            Inf      2.000
#> sort(b)            1    Inf      1.00            Inf        Inf
#> order(b)         NaN  0.000      0.00           0.00      0.000
#> rank(b)            1  1.000      0.25            Inf        Inf
#> quantile(b)        1    Inf      1.00           1.00      1.000
#> summary(b)         1  1.000      1.00           1.00      1.000
