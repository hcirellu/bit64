...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.017  0.017     0.016              0          0        0
#> factor   1.000  1.000     1.062            Inf        Inf      Inf
#> 
#> === sortordercache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.017  0.017     0.016          0.013          0        0
#> factor   1.000  1.000     1.062          1.308        Inf      Inf
#> 
#> === ordercache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.017  0.017     0.016          0.013       0.01        0
#> factor   1.000  1.000     1.062          1.308       1.70      Inf
#> 
#> === allcache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.017  0.017     0.016          0.013       0.01    0.012
#> factor   1.000  1.000     1.062          1.308       1.70    1.417
#> 
...
#> SESSION        0.017  0.017     0.016          0.013       0.01
#>               allcache
#> cache            0.000
#> match(s, b)      0.000
#> s %in% b         0.000
...
#> duplicated(b)  0.000  0.001     0.000          0.000       0.00
#> unique(b)      0.000  0.000     0.000          0.000       0.00
...
#> b %in% b         NaN      0       NaN            NaN        NaN
#> duplicated(b)    NaN      0       NaN            NaN        NaN
#> unique(b)        NaN    NaN       NaN            NaN        NaN
...
#> match(b, b)    0.001  0.001     0.001          0.000       0.00
#> b %in% b       0.000  0.001     0.000          0.000       0.00
#> duplicated(b)  0.000  0.001     0.000          0.000       0.00
#> unique(b)      0.000  0.000     0.000          0.000       0.00
...
#> order(b)         NaN    NaN       NaN            NaN        NaN
#> rank(b)            1    Inf       Inf            Inf        Inf
#> quantile(b)      NaN      0     0.000            NaN        NaN
...
#> b %in% s       0.000  0.000     0.001          0.000       0.00
#> match(b, b)    0.001  0.001     0.001          0.000       0.00
#> b %in% b       0.000  0.001     0.000          0.001       0.00
#> duplicated(b)  0.000  0.001     0.000          0.001       0.00
#> unique(b)      0.000  0.000     0.000          0.000       0.00
#> table(b)       0.002  0.001     0.001          0.001       0.00
#> sort(b)        0.000  0.000     0.001          0.000       0.00
#> order(b)       0.000  0.000     0.000          0.001       0.00
#> rank(b)        0.001  0.000     0.000          0.000       0.00
#> quantile(b)    0.000  0.001     0.001          0.006       0.00
...
#> b %in% s         NaN    NaN     0.000            NaN        NaN
#> match(b, b)        1      1     1.000            Inf        Inf
#> b %in% b         NaN      0       NaN          0.000        NaN
#> duplicated(b)    NaN      0       NaN          0.000        NaN
#> unique(b)        NaN    NaN       NaN            NaN        NaN
#> table(b)           1      2     2.000          2.000        Inf
#> sort(b)          NaN    NaN     0.000            NaN        NaN
#> order(b)         NaN    NaN       NaN          0.000        NaN
#> rank(b)            1    Inf       Inf            Inf        Inf
#> quantile(b)      NaN      0     0.000          0.000        NaN
#> summary(b)         1      1     1.000          1.000        Inf
...
#> match(b, s)    0.001  0.000     0.001          0.000      0.001
...
#> quantile(b)    0.000  0.001     0.001          0.006      0.001
#> summary(b)     0.001  0.001     0.001          0.001      0.001
#> factor(b)      0.002  0.001     0.001          0.002      0.002
#> SESSION        0.017  0.017     0.016          0.013      0.010
#>               allcache
#> cache            0.000
#> match(s, b)      0.000
#> s %in% b         0.000
...
#> match(b, s)        1    Inf     1.000            Inf        1.0
#> b %in% s         NaN    NaN     0.000            NaN        0.0
#> match(b, b)        1      1     1.000            Inf        1.0
#> b %in% b         NaN      0       NaN          0.000        NaN
#> duplicated(b)    NaN      0       NaN          0.000        NaN
...
#> order(b)         NaN    NaN       NaN          0.000        NaN
#> rank(b)            1    Inf       Inf            Inf        Inf
#> quantile(b)      NaN      0     0.000          0.000        0.0
#> summary(b)         1      1     1.000          1.000        1.0
#> factor(b)          1      2     2.000          1.000        1.0
#> SESSION            1      1     1.062          1.308        1.7
#>               allcache
#> cache              NaN
#> match(s, b)        Inf
