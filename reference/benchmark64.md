...
#> out of curiosity: how well rank-correlated are fact and parallel fact table?
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.014  0.015     0.014              0          0        0
#> factor   1.000  0.933     1.000            Inf        Inf      Inf
#> 
#> === sortordercache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> out of curiosity: how well rank-correlated are fact and parallel fact table?
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.014  0.015     0.014          0.011          0        0
#> factor   1.000  0.933     1.000          1.273        Inf      Inf
#> 
#> === ordercache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> out of curiosity: how well rank-correlated are fact and parallel fact table?
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.014  0.015     0.014          0.011       0.01        0
#> factor   1.000  0.933     1.000          1.273       1.40      Inf
#> 
#> === allcache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> out of curiosity: how well rank-correlated are fact and parallel fact table?
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.014  0.015     0.014          0.011       0.01    0.008
#> factor   1.000  0.933     1.000          1.273       1.40    1.750
#> 
...
#> SESSION        0.014  0.015     0.014          0.011       0.01
#>               allcache
#> cache            0.000
#> match(s, b)      0.000
#> s %in% b         0.000
...
#> match(b, s)    0.000  0.001     0.000          0.000       0.00
#> b %in% s       0.000  0.001     0.000          0.000       0.00
#> match(b, b)    0.000  0.001     0.000          0.000       0.00
...
#> s %in% b       0.000  0.001     0.004          0.000       0.00
#> match(b, s)    0.000  0.001     0.001          0.000       0.00
#> b %in% s       0.000  0.001     0.001          0.000       0.00
#> match(b, b)    0.000  0.001     0.001          0.000       0.00
#> b %in% b       0.000  0.001     0.001          0.000       0.00
#> duplicated(b)  0.000  0.000     0.000          0.000       0.00
#> unique(b)      0.000  0.001     0.000          0.000       0.00
#> table(b)       0.002  0.000     0.001          0.000       0.00
#> sort(b)        0.001  0.000     0.000          0.000       0.00
#> order(b)       0.000  0.001     0.001          0.000       0.00
#> rank(b)        0.001  0.001     0.001          0.000       0.00
...
#> match(s, b)    0.000  0.001     0.001          0.000       0.00
#> s %in% b       0.000  0.001     0.004          0.001       0.00
#> match(b, s)    0.000  0.001     0.001          0.001       0.00
#> b %in% s       0.000  0.001     0.001          0.001       0.00
#> match(b, b)    0.000  0.001     0.001          0.001       0.00
#> b %in% b       0.000  0.001     0.001          0.001       0.00
#> duplicated(b)  0.000  0.000     0.000          0.000       0.00
#> unique(b)      0.000  0.001     0.000          0.001       0.00
#> table(b)       0.002  0.000     0.001          0.000       0.00
#> sort(b)        0.001  0.000     0.000          0.000       0.00
#> order(b)       0.000  0.001     0.001          0.000       0.00
#> rank(b)        0.001  0.001     0.001          0.000       0.00
#> quantile(b)    0.001  0.000     0.001          0.000       0.00
#> summary(b)     0.000  0.001     0.001          0.001       0.00
#> SESSION        0.014  0.015     0.014          0.011       0.01
#>               allcache
#> cache            0.000
#> match(s, b)      0.000
...
#> rank(b)            1  1.000         1            Inf        Inf
#> quantile(b)        1    Inf         1            Inf        Inf
#> summary(b)       NaN  0.000         0          0.000        NaN
#> SESSION            1  0.933         1          1.273        1.4
#>               allcache
#> cache              NaN
#> match(s, b)        NaN
...
#> s %in% b       0.000  0.001     0.004          0.001      0.001
...
#> SESSION        0.014  0.015     0.014          0.011      0.010
#>               allcache
#> cache            0.000
#> match(s, b)      0.000
#> s %in% b         0.000
...
#> match(s, b)      NaN  0.000         0            NaN        NaN
#> s %in% b         NaN  0.000         0          0.000        0.0
#> match(b, s)      NaN  0.000         0          0.000        0.0
#> b %in% s         NaN  0.000         0          0.000        0.0
#> match(b, b)      NaN  0.000         0          0.000        0.0
#> b %in% b         NaN  0.000         0          0.000        NaN
#> duplicated(b)    NaN    NaN       NaN            NaN        NaN
#> unique(b)        NaN  0.000       NaN          0.000        NaN
#> table(b)           1    Inf         2            Inf        Inf
...
#> order(b)         NaN  0.000         0            NaN        NaN
#> rank(b)            1  1.000         1            Inf        1.0
#> quantile(b)        1    Inf         1            Inf        Inf
#> summary(b)       NaN  0.000         0          0.000        0.0
#> SESSION            1  0.933         1          1.273        1.4
#>               allcache
#> cache              NaN
#> match(s, b)        NaN
