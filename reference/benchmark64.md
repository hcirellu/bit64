...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.012   0.01     0.007          0.006       0.01        0
#> factor   1.000   1.20     1.714          2.000       1.20      Inf
#> 
#> === allcache ===
#> check data range, mean etc.
#> get all percentiles for plotting distribution shape
...
#> coerce to factor
#>         32-bit 64-bit hashcache sortordercache ordercache allcache
#> seconds  0.012   0.01     0.007          0.006       0.01    0.006
#> factor   1.000   1.20     1.714          2.000       1.20    2.000
#> 
...
#> b %in% s       0.001   0.00     0.000          0.000       0.00
#> match(b, b)    0.000   0.00     0.000          0.000       0.00
#> b %in% b       0.001   0.00     0.000          0.000       0.00
#> duplicated(b)  0.000   0.00     0.000          0.000       0.00
#> unique(b)      0.001   0.00     0.000          0.000       0.00
#> table(b)       0.002   0.00     0.000          0.000       0.00
#> sort(b)        0.000   0.00     0.000          0.000       0.00
#> order(b)       0.000   0.00     0.000          0.000       0.00
#> rank(b)        0.001   0.00     0.000          0.000       0.00
#> quantile(b)    0.001   0.00     0.000          0.000       0.00
#> summary(b)     0.000   0.00     0.000          0.000       0.00
#> factor(b)      0.001   0.00     0.000          0.000       0.00
#> SESSION        0.012   0.01     0.007          0.006       0.01
#>               allcache
#> cache            0.000
#> match(s, b)      0.000
#> s %in% b         0.000
...
#> unique(b)      0.001  0.001     0.000          0.000       0.00
...
#> factor(b)      0.001  0.002     0.000          0.000       0.00
#> SESSION        0.012  0.010     0.007          0.006       0.01
#>               allcache
#> cache            0.000
#> match(s, b)      0.000
#> s %in% b         0.000
...
#> match(b, b)    0.000  0.000     0.000          0.000       0.00
#> b %in% b       0.001  0.001     0.000          0.000       0.00
#> duplicated(b)  0.000  0.000     0.001          0.000       0.00
#> unique(b)      0.001  0.001     0.000          0.000       0.00
...
#> summary(b)     0.000  0.000     0.001          0.000       0.00
#> factor(b)      0.001  0.002     0.001          0.000       0.00
#> SESSION        0.012  0.010     0.007          0.006       0.01
#>               allcache
#> cache            0.000
#> match(s, b)      0.000
...
#> rank(b)        0.001  0.001     0.000          0.000       0.00
#> quantile(b)    0.001  0.000     0.001          0.000       0.00
#> summary(b)     0.000  0.000     0.001          0.001       0.00
#> factor(b)      0.001  0.002     0.001          0.001       0.00
#> SESSION        0.012  0.010     0.007          0.006       0.01
#>               allcache
#> cache            0.000
#> match(s, b)      0.000
...
#> rank(b)            1    1.0       Inf            Inf        Inf
#> quantile(b)        1    Inf     1.000            Inf        Inf
#> summary(b)       NaN    NaN     0.000              0        NaN
#> factor(b)          1    0.5     1.000              1        Inf
#> SESSION            1    1.2     1.714              2        1.2
#>               allcache
#> cache              NaN
#> match(s, b)        NaN
...
#> SESSION        0.012  0.010     0.007          0.006      0.010
#>               allcache
#> cache            0.000
#> match(s, b)      0.000
#> s %in% b         0.000
...
#> match(b, s)      NaN    NaN       NaN            NaN        NaN
#> b %in% s           1    1.0       Inf            Inf        1.0
#> match(b, b)      NaN    NaN       NaN            NaN        NaN
#> b %in% b           1    1.0       Inf            Inf        1.0
#> duplicated(b)    NaN    NaN     0.000            NaN        NaN
#> unique(b)          1    1.0       Inf            Inf        Inf
#> table(b)           1    Inf     2.000            Inf        Inf
#> sort(b)          NaN    NaN       NaN            NaN        NaN
#> order(b)         NaN    NaN       NaN            NaN        NaN
#> rank(b)            1    1.0       Inf            Inf        1.0
#> quantile(b)        1    Inf     1.000            Inf        Inf
#> summary(b)       NaN    NaN     0.000              0        NaN
#> factor(b)          1    0.5     1.000              1        1.0
#> SESSION            1    1.2     1.714              2        1.2
#>               allcache
#> cache              NaN
#> match(s, b)        NaN
